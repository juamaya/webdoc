...
const config = {
  ...
  projectName: "webdoc", // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
            ...
            items: [
...

              {
                ...
                to: "/docs/tutoriales_JMA/Markdown",
                  ...
                  {
                label: "Docker-React",
                to: "/docs/Tutoriales_Docker/Docker-React",
              },
        ...
        copyright: `&copy; ${new Date().getFullYear()} Juamaya 🍺 25 Project, Built with Docusaurus.`,
      },
      prism: {
